defmodule ToDoListWeb.TaskLiveTest do
  ...
  @create_attrs %{completed: true, description: "some description", due_date: "2023-04-26T13:36:00", remind_on: "2023-04-26T13:36:00"}
  @update_attrs %{completed: false, description: "some updated description", due_date: "2023-04-27T13:36:00", remind_on: "2023-04-27T13:36:00"}
  @invalid_attrs %{completed: false, description: nil, due_date: nil, remind_on: nil}
